...
cherrypy.config.update({"response.timeout":1000000,'log.access_file': '../supportFiles/logAccess_file.txt',
                        'log.error_file': '../supportFiles/logError_file.txt','log.screen':True})
...
site.root.templateVars['app_bar']=[('/','Intro'),('/app1','Widget1'),('/app2','Widget2'),('/app3','Widget3'),('/app4','Widget4'),('/app5','Widget5'),('/app6','Widget6'),('/app7','Widget7')]
